  ...
  return (
    ...
    >
      <div className="lg:bg-split-right-green-transparent bg-green-transparent">
        <div className="max-w-9xl mx-auto h-screen grid grid-col-1 lg:grid-cols-2 gap-4 items-center lg:justify-start text-center lg:text-left lg:pt-28 font-normal">
