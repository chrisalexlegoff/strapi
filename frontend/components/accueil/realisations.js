...
const Realisations = ({ realisations }) => {
  return (
    <div className="lg:bg-split-right-green-white bg-split-bottom-green-white">
      <div className="max-w-7xl mx-auto grid lg:grid-rows-5 grid-col-1 lg:grid-cols-2 gap-4 items-center lg:justify-start text-center lg:text-left py-20 font-normal text-white ">
        <div className="row-start-1 mx-auto w-3/4">
          <div
            className="uppercase leading-9 text-2xl text-center"
        ...
        <div className="row-start-2 mx-auto w-3/4">
          <div
            className="uppercase leading-9 text-xl text-center"
            dangerouslySetInnerHTML={{ __html: realisations.titre3 }}
          ></div>
        </div>
        <div className="row-start-3 mx-auto w-3/4">
          <div
            className="leading-9 text-base text-center"
        ...
        <div className="row-start-6 lg:row-start-5 mx-auto w-full">
